...
# setup
####
github.sh --install-path "/tmp/compile" --github-owner "helium" --github-repo "helium-wallet-rs" --compile-src 'cargo build --release'

# copy build file
cp /tmp/compile/target/release/helium-wallet /usr/local/bin/helium-wallet
